  ...
  return (
    <ViewBox>
      <AssignmentCreationContainer>
        ...
        <AssignmentBasicInfo disableSelection={props.disableSelection} />
        <FormDivider text="참여 연구원" />
        <ParticipatingResearcher disableSelection={props.disableSelection} />
        <FormDivider text="사업비" />
        <AssignmentBudget disableSelection={props.disableSelection} />
        <FormDivider text="계좌 정보" />
        <AssignmentAccount disableSelection={props.disableSelection} />
        <FormDivider text="사업비 사용카드" />
        <BusinessExpenseCard disableSelection={props.disableSelection} />
      </AssignmentCreationContainer>
    </ViewBox>
  );
};
