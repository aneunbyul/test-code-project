    ...
    <TableRow
      ...
      <TableCell
        ...
        <Button
          ...
          disabled={rowHasError || props.disableSelection}
          type="button"
          onClick={handleSave}>
          Save
        </Button>
...
class EditableTableSrc extends React.Component {
  state = {
...
const styles = () => ({
  table: {
    borderBottom: '0.1rem solid var(--dark03)',
  },
  tableHead: {
    borderBottom: '0.1rem solid var(--dark03)',
  },
  ...
  inputWrapperDiv: {},
  input: {
    fontSize: 'var(--global-text-size)',
    lineHeight: '0',
    backgroundColor: 'var(--dark01)',
    borderColor: 'var(--light01)',
    width: '150px',
  },
  error: {},
  selectFormControl: {},
...
export default withStyles(styles)(EditableTableSrc);
